$(document).ready(function(){
    ...
    var newOrder = document.getElementsByName('ordersNew');
    ...
    var packedOrder = document.getElementsByName('ordersPacked');
    ...
    var inTransitOrder = document.getElementsByName('ordersIntransit');
    ...
    var deliveredOrder = document.getElementsByName('ordersDelivered');
